...
all: testa_rainhas.cpp   rainhas.cpp rainhas.hpp 
	g++ -std=c++11 -Wall rainhas.cpp testa_rainhas.cpp -o testa_rainhas
	./testa_rainhas
	#use comentario se necessario

compile: testa_rainhas.cpp   rainhas.cpp rainhas.hpp 
	g++ -std=c++11 -Wall rainhas.cpp testa_rainhas.cpp -o testa_rainhas
